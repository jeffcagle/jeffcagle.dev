...
/**
 *
 * Takes in the menu array prop from the Layout menu graphql query, and displays the floating scroll menu.
 *
 * @param {Object} props
 * @param {Array.<{name: string, slug: string}>} props.menu The top level menu items.
 * @returns {HTMLElement} The HTML floating menu that appears on scroll.
 */
